...
Original file is located at
    https://colab.research.google.com/drive/1slKRmdTNlehbL0aLDs86NhQ1VPKPwzMO
"""

dataset_path = "/content/drive/MyDrive/Kaggle/anime_faces"
...
images_path = glob("/content/drive/MyDrive/Kaggle/anime_faces/*")
...
w_init = tf.keras.initializers.RandomNormal(mean=0.0, stddev=0.02, seed=42)
w_init.get_config()
...
for no, element in enumerate(dataset.take(1).unbatch()):
    print(no, element.shape)
